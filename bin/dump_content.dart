...
void main(List<String> args) {
  ...
  try {
    ...
    if (fileExtension == '.csv') {
      ...
      if (textDelimiter != null) print('Using text delimiter: "$textDelimiter"');
